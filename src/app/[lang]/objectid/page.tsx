...
function ObjectIdToolPageContent() {
  ...
  return (
    <div className="min-h-screen flex flex-col">
      <StructuredData 
        type="tool" 
        toolName={language === 'zh' ? "MongoDB ObjectID 生成器" : "MongoDB ObjectID Generator"} 
        toolDescription={language === 'zh' 
        ...
        url={`https://tools.mofei.life/${language}/objectid`}
      />
      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            "name": language === 'zh' ? "MongoDB ObjectID 生成器" : "MongoDB ObjectID Generator",
            ...
            "mainEntity": {
              ...
              "name": language === 'zh' ? "ObjectID 生成器" : "ObjectID Generator",
              "applicationCategory": language === 'zh' ? "数据库工具" : "Database Tool",
              "downloadUrl": `https://tools.mofei.life/${language}/objectid`,
              "featureList": language === 'zh' ? [
                "生成 MongoDB ObjectID",
                "自定义时间戳支持",
                "ObjectID 结构分析",
                "时间戳提取",
            ...
            "potentialAction": {
              "@type": "UseAction",
              "target": `https://tools.mofei.life/${language}/objectid`,
              "name": language === 'zh' ? "生成 ObjectID" : "Generate ObjectID"
            },
            "sameAs": [
              "https://tools.mofei.life/objectid",
              "https://tools.mofei.life/en/objectid", 
              "https://tools.mofei.life/zh/objectid"
            ]
          })
        }}
      />
            ...
            "itemListElement": [
              {
                "@type": "ListItem",
                "position": 1,
                "name": language === 'zh' ? "Mofei 开发工具" : "Mofei Dev Tools",
                "item": `https://tools.mofei.life/${language === 'en' ? '' : language}`
              },
              {
                "@type": "ListItem",
                "position": 2,
                "name": language === 'zh' ? "开发工具" : "Developer Tools",
                "item": `https://tools.mofei.life/${language === 'en' ? '' : language}#dev-tools`
              },
              {
                "@type": "ListItem",
                "position": 3,
                "name": language === 'zh' ? "ObjectID 生成器" : "ObjectID Generator",
                "item": `https://tools.mofei.life/${language}/objectid`
              }
            ]
          })
        }}
        ...
        >
          ...
          >
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <Link 
                href={language === 'en' ? '/en/json-extract' : '/zh/json-extract'}
              ...
              <Link 
                href={language === 'en' ? '/en/base64' : '/zh/base64'}
                className="group p-4 bg-gray-800/50 rounded-lg border border-gray-700 hover:border-[#a1c4fd]/50 transition-all duration-300 hover:bg-gray-700/50"
              >
                <div className="flex items-center gap-3 mb-2">
                  <span className="text-2xl">🔤</span>
