...
export const BBOX_TEXT: Record<BBoxLanguage, Record<BBoxTextKey, string>> = {
  en: {
    ...
    mapUnavailableDesc: 'Set NEXT_PUBLIC_MAPBOX_ACCESS_TOKEN in .env.local for local development, or in Cloudflare Build variables for deploys. See README > Environment.',
  ...
  zh: {
    ...
    mapUnavailableDesc: '本地开发请在 .env.local 设置 NEXT_PUBLIC_MAPBOX_ACCESS_TOKEN；Cloudflare 部署请放到 Build variables。详见 README 的 Environment 段落。',
  ...
  de: {
    ...
    mapUnavailableDesc: 'Setze NEXT_PUBLIC_MAPBOX_ACCESS_TOKEN lokal in .env.local oder für Deployments in Cloudflare Build variables. Siehe README > Environment.',
  ...
  es: {
    ...
    mapUnavailableDesc: 'Define NEXT_PUBLIC_MAPBOX_ACCESS_TOKEN en .env.local para desarrollo local o en Cloudflare Build variables para despliegues. Consulta README > Environment.',
  ...
  fr: {
    ...
    mapUnavailableDesc: 'Définissez NEXT_PUBLIC_MAPBOX_ACCESS_TOKEN dans .env.local en local ou dans Cloudflare Build variables pour les déploiements. Voir README > Environment.',
