...
const translations = {
  zh: {
    ...
    'tools.base64.description': 'Base64编码解码工具，支持智能图片 Base64 提取与预览',
    ...
    'base64.subtitle': '快速进行 Base64 编码解码，并智能预览图片 Base64 内容',
    ...
    'base64.imagePreview': '图片预览（智能提取）',
    'base64.imagePreviewAlt': 'Base64 图片预览',
    'base64.imagePreviewHintDataUrl': '已从 data URL 中提取图片内容并完成预览',
    'base64.imagePreviewHintExtracted': '已从输入内容中智能提取主要 Base64 片段并完成预览',
    'base64.imagePreviewNoMatch': '未识别到可预览的图片 Base64 内容（请粘贴更完整的字符串）',
    ...
    'footer.descriptionBefore': '欢迎访问我的博客 ',
    'footer.descriptionAfter': '。我用心整理了这些开发工具，希望能让编程变得更轻松愉快——欢迎体验和分享！'
  },
  en: {
    'nav.tools': 'All Tools',
    'nav.github': 'Star & Fork', 
    ...
    'tools.base64.name': 'Base64',
    'tools.base64.description': 'Base64 encode/decode tool with smart Base64 image extraction and preview',
    ...
    'base64.subtitle': 'Quick Base64 encode/decode with smart image Base64 preview',
    ...
    'base64.imagePreview': 'Image Preview (Smart Extract)',
    'base64.imagePreviewAlt': 'Base64 image preview',
    'base64.imagePreviewHintDataUrl': 'Image content was extracted from a data URL and previewed.',
    'base64.imagePreviewHintExtracted': 'Main Base64 content was smartly extracted from your text and previewed.',
    'base64.imagePreviewNoMatch': 'No previewable image Base64 was found. Please paste a more complete string.',
    ...
    'footer.descriptionAfter': '. I built this collection of development tools to make coding life easier—feel free to explore and enjoy!'
  }
};
